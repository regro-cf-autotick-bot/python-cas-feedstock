...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-cas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15127&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-cas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-cas` can be installed with:

```
conda install python-cas
```

It is possible to list all of the versions of `python-cas` available on your platform with:
